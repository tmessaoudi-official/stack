...
if [ -f "${GLOBAL_STACK_DOCKER_ROOT_PATH}"/.env.local ]; then
	...
	PATH="${RBENV_ROOT}/bin:${PYENV_ROOT}/bin:${GLOBAL_STACK_DOCKER_TOOLS_PATH}/bin:${COMPOSER_HOME}/vendor/bin:${COMPOSER_HOME}/source/bin:${SYMFONY_HOME}/bin:${PHPBREW_BIN}:${PHPBREW_SRC}/bin:${PHPBREW_PHP_PATH}/bin:${PHPBREW_PHP_PATH}/sbin:${PNPM_HOME}:${PNPM_HOME}/4/node_modules/.bin:${PNPM_HOME}/5/node_modules/.bin:${YARN_GLOBAL_FOLDER}/bin:${DENO_INSTALL}/bin:${CARGO_HOME}/bin:${RUSTUP_HOME}/toolchains/stable-x86_64-unknown-linux-gnu/bin/:${PUB_CACHE}/bin:${JAVA_HOME}/bin:${ANDROID_HOME}/cmdline-tools/bin:${ANDROID_HOME}/cmdline-tools/tools/bin:${ANDROID_HOME}/tools:${ANDROID_HOME}/tools/bin:${ANDROID_HOME}/platform-tools:${ANDROID_HOME}/build-tools/${GLOBAL_STACK_ANDROID_BUILD_TOOLS_VERSION}:${GLOBAL_STACK_DOCKER_TOOLS_PATH}/flutter/bin:${ANDROID_NDK_HOME}:${PATH}"
