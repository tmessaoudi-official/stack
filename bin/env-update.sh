...
# (github, npm, pecl, pecl-git, pypi, rubygems, sdkman, sdkmanager, codeberg,
# quay, url) still require this script until env-update-v2.sh Phase 3+ is
# complete (see REMOVAL CONDITION below).
