...
global_stack_load_env_main() {
	...
	local -A DEFAULTS=(
		...
		[GLOBAL_STACK_LOAD_ENV_EXCLUDE_REVERSE_CHECK_MISSING]='^(ARG )?(COMPOSE_DOCKER_CLI_BUILD|COMPOSE_PROJECT_NAME|GLOBAL_STACK_COMPOSE_CLI|COMPOSE_FILE|COMPOSE_BAKE|BUILDX_EXPERIMENTAL|BUILDKIT_PROGRESS|BUILDX_BUILDER|GLOBAL_STACK_HOST_GATEWAY_IP_MASK|COMPOSE_FULL_FILE|BUILDX_BAKE_FILE|COMPOSE_HTTP_TIMEOUT|COMPOSE_PATH_SEPARATOR|COMPOSE_REMOVE_ORPHANS|DOCKER_BUILDKIT|GLOBAL_STACK_LOCAL_REGISTRY_NAME|GLOBAL_STACK_LOCAL_REGISTRY_VERSION|GLOBAL_STACK_SERVERLESS_FRAMEWORK_HOST|GLOBAL_STACK_BASE_CA_BUNDLE|GLOBAL_STACK_RELOAD_PHP[0-9]+_[0-9]+|GLOBAL_STACK_LOCALSTACK_LOCALSTACK_PORT_4566|GLOBAL_STACK_LOCALSTACK_LOCALSTACK_PORT_4566_WITH_STARTING_POINTS)'
