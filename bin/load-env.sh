...
global_stack_load_env_main() {
	...
	local -A DEFAULTS=(
		...
		[GLOBAL_STACK_LOAD_ENV_EXCLUDE_DIFFERENT_PATTERN]='^(ARG )?(GLOBAL_STACK_POSTGRES17_DBS|GLOBAL_STACK_EXPOSED_VIRTUAL_HOSTS|GLOBAL_STACK_HTTPS_LOCALHOST_IPS|GLOBAL_STACK_HTTPS_CONTAINER_IPS|GLOBAL_STACK_PODMAN_CHANEL|COMPOSE_FILE|COMPOSE_BAKE|BUILDX_EXPERIMENTAL|GLOBAL_STACK_HOST_GATEWAY_IP|GLOBAL_STACK_SERVERLESS_FRAMEWORK_SERVERLESS_ACCESS_KEY|GLOBAL_STACK_(.+)_PORT_[0-9]+(.*))'
