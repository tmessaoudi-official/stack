...
gs_es_parse_args() {
	while [[ $# -gt 0 ]]; do
		case "${1}" in
		--debug=*)                        _GS_ES_CFG[debug]="${1#*=}";                        _GS_ES_CFG[debug]="${_GS_ES_CFG[debug],,}" ;;
		--debug-show-extracted-files=*)   _GS_ES_CFG[debug_show_extracted_files]="${1#*=}";   _GS_ES_CFG[debug_show_extracted_files]="${_GS_ES_CFG[debug_show_extracted_files],,}" ;;
		--strip-comments=*)               _GS_ES_CFG[strip_comments]="${1#*=}";               _GS_ES_CFG[strip_comments]="${_GS_ES_CFG[strip_comments],,}" ;;
		--remove-empty-lines=*)           _GS_ES_CFG[remove_empty_lines]="${1#*=}";           _GS_ES_CFG[remove_empty_lines]="${_GS_ES_CFG[remove_empty_lines],,}" ;;
		--remove-trailing-spaces=*)       _GS_ES_CFG[remove_trailing_spaces]="${1#*=}";       _GS_ES_CFG[remove_trailing_spaces]="${_GS_ES_CFG[remove_trailing_spaces],,}" ;;
		--show-added-entries=*)           _GS_ES_CFG[show_added_entries]="${1#*=}";           _GS_ES_CFG[show_added_entries]="${_GS_ES_CFG[show_added_entries],,}" ;;
		--show-different-entries=*)       _GS_ES_CFG[show_different_entries]="${1#*=}";       _GS_ES_CFG[show_different_entries]="${_GS_ES_CFG[show_different_entries],,}" ;;
		--scan-sources=*)                 _GS_ES_CFG[scan_sources]="${1#*=}";                 _GS_ES_CFG[scan_sources]="${_GS_ES_CFG[scan_sources],,}" ;;
		--scan-delete-output=*)           _GS_ES_CFG[scan_delete_output]="${1#*=}";           _GS_ES_CFG[scan_delete_output]="${_GS_ES_CFG[scan_delete_output],,}" ;;
		--check-missing=*)                _GS_ES_CFG[check_missing]="${1#*=}";                _GS_ES_CFG[check_missing]="${_GS_ES_CFG[check_missing],,}" ;;
		--cleanup-tmp=*)                  _GS_ES_CFG[cleanup_tmp]="${1#*=}";                  _GS_ES_CFG[cleanup_tmp]="${_GS_ES_CFG[cleanup_tmp],,}" ;;
		--include-docker-args=*)          _GS_ES_CFG[include_docker_args]="${1#*=}";          _GS_ES_CFG[include_docker_args]="${_GS_ES_CFG[include_docker_args],,}" ;;
