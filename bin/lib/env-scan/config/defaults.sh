...
_p+='|GLOBAL_STACK_PYTHON_VERSION'
_p+='|GLOBAL_STACK_RUBY_VERSION'
_p+='|GLOBAL_STACK_CURRENT_VERSION'
_p+='|GLOBAL_STACK_IMAGE_MARIADB_VERSION'
_p+='|GLOBAL_STACK_IMAGE_MONGO_VERSION'
_p+='|GLOBAL_STACK_IMAGE_MYSQL_VERSION'
_p+='|GLOBAL_STACK_IMAGE_POSTGRES_VERSION'
_p+='|GLOBAL_STACK_SHOW_WAITING'
_p+=')'
