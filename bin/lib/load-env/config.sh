#!/bin/bash
# config.sh — _LE_CFG defaults and pattern constants for load-env

# Include guard
[[ -n "${_LE_CONFIG_SH_LOADED:-}" ]] && return 0
readonly _LE_CONFIG_SH_LOADED=1
