...
#           defines the check loop, and _gs_eu2_main.
#
...
#            (tally functions now in reporting/tally.sh)
#            (signal functions now in core/drift.sh)
...
# shellcheck source=./reporting/tally.sh
source "$(dirname "${BASH_SOURCE[0]}")/reporting/tally.sh"
# shellcheck source=./core/drift.sh
source "$(dirname "${BASH_SOURCE[0]}")/core/drift.sh"
