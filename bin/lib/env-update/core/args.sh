...
_gs_eu2_parse_args() {
  while [[ $# -gt 0 ]]; do
    case "${1}" in
      ...
      --dump|--dump=true)               _GS_EU2_CFG[dump]="true" ;;
      --dump=false)                     _GS_EU2_CFG[dump]="false" ;;
      --format=*)     _GS_EU2_CFG[format]="${1#*=}" ;;
      --dry-run|--dry-run=true)         _GS_EU2_CFG[dry_run]="true" ;;
      --dry-run=false)                  _GS_EU2_CFG[dry_run]="false" ;;
      --check|--check=true)             _GS_EU2_CFG[check]="true" ;;
      --check=false)                    _GS_EU2_CFG[check]="false" ;;
      --apply|--apply=true)             _GS_EU2_CFG[apply]="true" ;;
      --apply=false)                    _GS_EU2_CFG[apply]="false" ;;
      --scan|--scan=true)               _GS_EU2_CFG[scan]="true" ;;
      --scan=false)                     _GS_EU2_CFG[scan]="false" ;;
      --no-cache|--no-cache=true)       _GS_EU2_CFG[no_cache]="true" ;;
      --no-cache=false)                 _GS_EU2_CFG[no_cache]="false" ;;
      --with-tags|--with-tags=true)     _GS_EU2_CFG[with_tags]="true" ;;
      --with-tags=false)                _GS_EU2_CFG[with_tags]="false" ;;
      --no-notes|--no-notes=true)       _GS_EU2_CFG[no_notes]="true" ;;
      --no-notes=false)                 _GS_EU2_CFG[no_notes]="false" ;;
      --no-drift|--no-drift=true)       _GS_EU2_CFG[no_drift]="true" ;;
      --no-drift=false)                 _GS_EU2_CFG[no_drift]="false" ;;
      --apply-resolve|--apply-resolve=true)   _GS_EU2_CFG[apply_resolve]="true" ;;
      --apply-resolve=false)                  _GS_EU2_CFG[apply_resolve]="false" ;;
      --force-auto|--force-auto=true)   _GS_EU2_CFG[force_auto]="true" ;;
      --force-auto=false)               _GS_EU2_CFG[force_auto]="false" ;;
      --force-hold|--force-hold=true)   _GS_EU2_CFG[force_hold]="true" ;;
      --force-hold=false)               _GS_EU2_CFG[force_hold]="false" ;;
      --changes-only|--changes-only=true)   _GS_EU2_CFG[changes_only]="true" ;;
      --changes-only=false)                 _GS_EU2_CFG[changes_only]="false" ;;
      --no-fail|--no-fail=true)         _GS_EU2_CFG[no_fail]="true" ;;
      --no-fail=false)                  _GS_EU2_CFG[no_fail]="false" ;;
      --profile|--profile=true)         _GS_EU2_CFG[profile]="true" ;;
      --profile=false)                  _GS_EU2_CFG[profile]="false" ;;
      --yes|--yes=true)                 _GS_EU2_CFG[yes]="true" ;;
      --yes=false)                      _GS_EU2_CFG[yes]="false" ;;
