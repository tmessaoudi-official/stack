...
- **env-update tests**: `bash bin/tests/env-update.test.sh` — 352 tests across 56 sections (fetchers, cache, semver, apply, args…); use `--dry-run --filter=<VAR>` and `--offline` for manual cache-only testing
