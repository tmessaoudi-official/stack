...
# @todo check-updates
while true; do echo 'y'; sleep 2; done | sdkmanager --sdk_root="${ANDROID_HOME}" "cmdline-tools;${GLOBAL_STACK_ANDROID_CMDLINE_TOOLS_VERSION}" "platform-tools" "build-tools;34.0.0" "build-tools;35.0.1" "build-tools;36.1.0" "ndk-bundle" "ndk;${GLOBAL_STACK_ANDROID_NDK_VERSION}" "platforms;android-35" "platforms;android-36" "platforms;android-36.1" "extras;android;m2repository" "extras;google;google_play_services" "extras;google;instantapps" "extras;google;m2repository" "add-ons;addon-google_apis-google-22" "add-ons;addon-google_apis-google-23" "add-ons;addon-google_apis-google-24"
