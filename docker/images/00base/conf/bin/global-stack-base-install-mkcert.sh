...
wget -O /usr/local/bin/mkcert https://github.com/FiloSottile/mkcert/releases/download/"${STACK_MKCERT_LATEST_VERSION}"/mkcert-"${STACK_MKCERT_LATEST_VERSION}"-linux-amd64
